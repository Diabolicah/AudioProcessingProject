...
\midrule
TCAV importance      & 9.11 & 8.96 & $-0.740$ \\
Shuffled (control)   & 9.05 & 9.02 & $-0.740$ \\
Random subspace (noise) & 9.36 & 9.36 & $-0.003$ \\
\bottomrule
\end{tabular}
\end{table}
...
directions costs $0.740$ of margin, whereas deleting $12$ random directions
costs $0.003$, a factor of roughly $250$. Since both interventions remove
...
importance (AUC $9.11$) is no better than shuffling them (AUC $9.05$), and both
